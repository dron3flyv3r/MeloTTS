# Light MeloTTS
This is just a lightwaight verion of the MeloTTS, where I have removed any unnessesary files and functions. This only works for english models. This can also use my own custom trained models.
